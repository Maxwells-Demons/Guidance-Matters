...
from pipelines.sdxl_apg import MomentumBuffer, normalized_guidance
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                if self.interrupt:
                    continue
                if len(self.guidance_scale_list) == 0 or self.adaptive_projected_guidance:
                ...
                if self.do_classifier_free_guidance:
                    if adaptive_projected_guidance:
                        ...
                        main_axis = noise_pred_text - noise_pred_uncond
                        v2 = self.guidance_scale * main_axis
                        ...
                        vv = v1 - vp
                        eq_guidance_scale = torch.norm(vp, p=2) / torch.norm(main_axis, p=2)
