...
class Evaluator:
    def __init__(self):
        ...
        self.ir_model = reward.load("ImageReward-v1.0", device=device)
...
class AestheticScorer(torch.nn.Module):
    def __init__(self, dtype):
        super().__init__()
        self.clip = CLIPModel.from_pretrained('openai/clip-vit-large-patch14', local_files_only=True).to(device)
