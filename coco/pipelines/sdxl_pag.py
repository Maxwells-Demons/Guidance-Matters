    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                if self.interrupt:
                    continue
                if len(self.guidance_scale_list) == 0 or self.do_perturbed_attention_guidance:
                ...
                if self.do_perturbed_attention_guidance:
                    ...
                    noise_pred, noise_pred_text = self._apply_perturbed_attention_guidance(
                        noise_pred, self.do_classifier_free_guidance, guidance_scale, t, True
                    )

                    v2 = guidance_scale * (noise_pred_text - noise_pred_uncond)
